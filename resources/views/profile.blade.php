...
<body class="h-screen flex items-center justify-center bg-[#1B1B1B] text-white">
    ...
    <div class="bg-[#2A2A2A] p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <form method="POST" action="" class="space-y-4">
            ...
            <div class="flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                    ...
                    <input type="text" name="name" value="{{$user->name}}" class="w-full p-3 bg-[#3A3A3A] text-white border border-[#EAC696] rounded focus:outline-none focus:ring-2 focus:ring-[#EAC696] font-modern" required>
                </div>
                <div class="flex-1">
                    <label class="block text-[#EAC696] font-elegant text-lg">Apellido</label>
                    <input type="text" name="surname"value="{{$user->surname}}" class="w-full p-3 bg-[#3A3A3A] text-white border border-[#EAC696] rounded focus:outline-none focus:ring-2 focus:ring-[#EAC696] font-modern" required>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="username" value={{$user->username}} class="w-full p-3 bg-[#3A3A3A] text-white border border-[#EAC696] rounded focus:outline-none focus:ring-2 focus:ring-[#EAC696] font-modern" required>
            </div>
            <div>
                <label class="block text-[#EAC696] font-elegant text-lg">Correo Electrónico</label>
                <input type="email" name="email" value= {{$user->email}} class="w-full p-3 bg-[#3A3A3A] text-white border border-[#EAC696] rounded focus:outline-none focus:ring-2 focus:ring-[#EAC696] font-modern" required>
            </div>
        ...
        <p class="mt-4 text-center text-gray-300">
            ¿Ya tienes cuenta? 
            <a href="" class="text-[#EAC696] hover:underline font-elegant">Inicia sesión</a>
        </p>
    </div>
